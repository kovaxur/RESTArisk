...
class Asterisk(DB.DB):
    #metadata = MetaData()
    Base = declarative_base()

    def __init__(self, user: str = None, password: str = None, host: str = None, db: str = None, type: str = 'postgresql'):
    ...
    #sipfriends = Table('sipfriends', metadata,
    #                   Column('id', Integer, primary_key=True, nullable=False),
    #                   Column('name', String(10), nullable=False),
    #                   Column('ipaddr', String(15), server_default=None),
    #                   Column('port', Integer, server_default=None),
    #                   Column('regseconds', Integer, server_default=None),
    #                   Column('defaultuser', String(10), server_default=None),
    #                   Column('fullcontact', String(35), server_default=None),
    #                   Column('regserver', String(20), server_default=None),
    #                   Column('useragent', String(20), server_default=None),
    #                   Column('lastms', Integer, server_default=None),
    #                   Column('host', String(40), server_default=None),
    #                   Column('type', Enum('friend', 'user', 'peer', name='typeT'), server_default=None),
    #                   Column('context', String(40), server_default=None),
    #                   Column('permit', String(40), server_default=None),
    #                   Column('deny', String(40), server_default=None),
    #                   Column('secret', String(40), server_default=None),
    #                   Column('md5secret', String(40), server_default=None),
    #                   Column('remotesecret', String(40), server_default=None),
    #                   Column('transport', Enum('udp', 'tcp', 'udp,tcp', 'tcp,udp', name='transportT'), server_default=None),
    #                   Column('dtmfmode', Enum('rfc2833', 'info', 'shortinfo', 'inband', 'auto', name='dtmfmodeT'), server_default=None),
    #                   Column('directmedia', Enum('yes', 'no', 'nonat', 'update', name='directmediaT'), server_default=None),
    #                   Column('nat', Enum('yes', 'no', 'never', 'route', name='natT'), server_default=None),
    #                   Column('callgroup', String(40), server_default=None),
    #                   Column('pickupgroup', String(40), server_default=None),
    #                   Column('language', String(40), server_default=None),
    #                   Column('allow', String(40), server_default=None),
    #                   Column('disallow', String(40), server_default=None),
    #                   Column('insecure', String(40), server_default=None),
    #                   Column('trustrpid', Enum('yes', 'no', name='trustrpidT'), server_default=None),
    #                   Column('progressinband', Enum('yes', 'no', 'never', name='progressinbandT'), server_default=None),
    #                   Column('promiscredir', Enum('yes', 'no', name='promiscredirT'), server_default=None),
    #                   Column('useclientcode', Enum('yes', 'no', name='useclientcodeT'), server_default=None),
    #                   Column('accountcode', String(40), server_default=None),
    #                   Column('setvar', String(40), server_default=None),
    #                   Column('callerid', String(40), server_default=None),
    #                   Column('amaflags', String(40), server_default=None),
    #                   Column('callcounter', Enum('yes', 'no', name='callcounterT'), server_default=None),
    #                   Column('busylevel', Integer, server_default=None),
    #                   Column('allowoverlap', Enum('yes', 'no', name='allowoverlapT'), server_default=None),
    #                   Column('allowsubscribe', Enum('yes', 'no', name='allowsubscribeT'), server_default=None),
    #                   Column('videosupport', Enum('yes', 'no', name='videosupportT'), server_default=None),
    #                   Column('maxcallbitrate', Integer, server_default=None),
    #                   Column('rfc2833compensate', Enum('yes', 'no', name='rfc2833compensateT'), server_default=None),
    #                   Column('mailbox', String(40), server_default=None),
    #                   Column('session-timers', Enum('accept', 'refuse', 'originate', name='sessiontimersT'), server_default=None),
    #                   Column('session-expires', Integer, server_default=None),
    #                   Column('session-minse', Integer, server_default=None),
    #                   Column('session-refresher', Enum('uac', 'uas'), server_default=None),
    #                   Column('t38pt-usertpsource', String(40), server_default=None,),
    #                   Column('regexten', String(40), server_default=None),
    #                   Column('fromdomain', String(40), server_default=None),
    #                   Column('fromuser', String(40), server_default=None),
    #                   Column('qualify', String(40), server_default=None),
    #                   Column('defaultip', String(40), server_default=None),
    #                   Column('rtptimeout', Integer, server_default=None),
    #                   Column('rtpholdtimeout', Integer, server_default=None),
    #                   Column('sendrpid', Enum('yes', 'no', name='sendrpidT'), server_default=None),
    #                   Column('outboundproxy', String(40), server_default=None),
    #                   Column('callbackextension', String(40), server_default=None),
    #                   Column('registertrying', Enum('yes', 'no', name='registertryingT'), server_default=None),
    #                   Column('timert1', Integer, server_default=None),
    #                   Column('timerb', Integer, server_default=None),
    #                   Column('qualifyfreq', Integer, server_default=None),
    #                   Column('constantssrc', Enum('yes', 'no', name='constantssrcT'), server_default=None),
    #                   Column('contactpermit', String(40), server_default=None),
    #                   Column('contactdeny', String(40), server_default=None),
    #                   Column('usereqphone', Enum('yes', 'no', name='usereqphoneT'), server_default=None),
    #                   Column('textsupport', Enum('yes', 'no', name='textsupportT'), server_default=None),
    #                   Column('faxdetect', Enum('yes', 'no', name='faxdetectT'), server_default=None),
    #                   Column('buggymwi', Enum('yes', 'no', name='buggymwiT'), server_default=None),
    #                   Column('auth', String(40), server_default=None),
    #                   Column('fullname', String(40), server_default=None),
    #                   Column('trunkname', String(40), server_default=None),
    #                   Column('cid-number', String(40), server_default=None),
    #                   Column('callingpres', Enum('allowed_not_screened', 'allowed_passed_screen', 'allowed_failed_screen',
    #                                              'allowed', 'prohibscreened', 'prohib_passed_screen', 'prohib_failed_screen',
    #                                              'prohib', name='callingpresT'), server_default=None),
    #                   Column('mohintegererpret', String(40), server_default=None),
    #                   Column('mohsuggest', String(40), server_default=None),
    #                   Column('parkinglot', String(40), server_default=None),
    #                   Column('hasvoicemail', Enum('yes', 'no', name='hasvoicemailT'), server_default=None),
    #                   Column('subscribemwi', Enum('yes', 'no', name='subscribemwiT'), server_default=None),
    #                   Column('vmexten', String(40), server_default=None),
    #                   Column('autoframing', Enum('yes', 'no', name='autoframingT'), server_default=None),
    #                   Column('rtpkeepalive', Integer, server_default=None),
    #                   Column('call-limit', Integer, server_default=None),
    #                   Column('g726nonstandard', Enum('yes', 'no', name='g726nonstandardT'), server_default=None),
    #                   Column('ignoresdpversion', Enum('yes', 'no', name='ignoresdpversionT'), server_default=None),
    #                   Column('allowtransfer', Enum('yes', 'no', name='allowtransferT'), server_default=None),
    #                   Column('dynamic', Enum('yes', 'no', name='dynamicT'), server_default=None)
    #                   )
    ...
    class Sipfriends(Base):
        ...
        t38pt_usertpsource = Column(String(40), server_default=None, name='t38pt-usertpsource')
        ...
        cid_number = Column(String(40), server_default=None, name='cid-number')
